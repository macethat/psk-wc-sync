...
$c = str_replace(
    ...
    '.blog-style-grid .entry-title { order: 1 !important; margin-bottom: 12px !important; font-size: 22px !important; } .blog-style-grid .entry-title a { font-size: 22px !important; }',
    $c
);
